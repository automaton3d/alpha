...
cd /d %~dp0..
cl /nologo /std:c++20 /O2 /EHsc /MD /D NOMINMAX /D ORPHAN_GUIDANCE_FSM /D ORPHAN_DUMP_SRC /I src\include /I src\include\zlib /I src ^
    ...
    /Fe:experiments\alpha_probe_dumpsrc.exe
